...
original_author="Amlakkolbe20"
original_name="sa"
original_urlname="Sa"
original_description="Awesome sa created by Amlakkolbe20" 
...
then
    ...
    echo "then run 'sa' or 'python -m sa'"
else
    poetry install
    echo "Applied Flask template"
    echo "Ensure you activate your env with 'poetry shell'"
    echo "then run 'sa' or 'python -m sa' or 'poetry run sa'"
fi
